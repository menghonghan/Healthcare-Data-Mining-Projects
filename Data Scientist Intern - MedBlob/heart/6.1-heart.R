...
colnames(table_final2) = c('SEQN','Gender','RaceMexican_American','RaceOther_Hispanic','RaceNonHispanic_White','RaceNonHispanic_Black','RaceNonHispanic_Asian','RaceOther Race - Including Multi-Racial','Diabetes','No_(Pre)_Diabetes','Angina','Close_Relative_Heart_Attack','Close_Relative_Asthma','Close_Relative_Diabetes','Overweight','Lack_Exercise','High_Salt_in_Diet','Hight_Fat/Calories','Age','BMI','Pulse','AVG_Systolic_Blood_Pressure','AVG_Diastolic_Blood_Pressure','Total_Cholesterol','Atherosclerosis_Index','Complete_Blood_Count_with_5-part_Differential','Standard_Biochemistry_Profile','Uric_Acid','y')
